...
@MainActor class SpaceViewModel: ObservableObject {
    ...
    func addPilot() {
        ...
        pilot.pilotNode.position = SCNVector3(x: 0, y:2, z: 150)
    ...
    func addBlackHole(radius: CGFloat, ringCount: Int, vibeOffset: Int, bothRings: Bool, vibe: String) -> BlackHole {
        ...
        blackHole.blackHoleNode.worldPosition = SCNVector3(x: Float.random(in: -35...35), y:Float.random(in: -20...20), z: Float.random(in: -20...20))
